...
<div class="card shadow  mb-5 bg-body rounded" style="width: 700px">
			...
			<div class="card-body">
				<sf:form role="form" action="${pageContext.request.contextPath}/home/login" method="post" modelAttribute="form">
					<s:bind path="login">
							<div class="mb-3">
							...
							<input type="submit" name="operation" class="btn btn-primary pull-right"
								value="SignIn">
							<a href="${pageContext.request.contextPath}/home/login/forgetPassword">Forget Password ?</a>
				</sf:form>
			</div>
		</div>
	</div>
